...
export default function ConsultantAllOutFooterSection() {
  ...
  return (
    <footer className="">
      <div className="bg-consAccent h-full flex flex-col items-center text-white w-full md:px-0 pt-10">
        ...
        <div className="text-black w-full lg:px-56 text-white py-2">
