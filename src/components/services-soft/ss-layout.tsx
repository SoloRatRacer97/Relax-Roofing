...
import { SSInfoWithSticky } from './ss-info-with-sticky-nav';
...
export default function SSLayoutRegular({
  children,
  ...
  return (
    <div className="">
      ...
      <div className="sticky fixed top-0 h-20 z-50">
        <SSInfoWithSticky items={siteConfig.mainNav} href={href}></SSInfoWithSticky>
      </div>
